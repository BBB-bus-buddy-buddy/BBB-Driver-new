...
const getDateString = (daysFromToday = 0, hours = 0, minutes = 0) => {
  ...
  export const generateDummyNotifications = () => {
    return [
      {
        id: 1,
        message: '내일 오전 6:30 운행 일정이 있습니다.',
        time: '30분 전',
        unread: true,
        type: 'schedule'
      },
      {
        id: 2,
        message: '이번 주 안전 운행 점수가 업데이트되었습니다.',
        time: '2시간 전',
        unread: true,
        type: 'safety'
      },
      {
        id: 3,
        message: '노선 변경 안내: 동부캠퍼스 정류장 위치가 변경되었습니다.',
        time: '어제',
        unread: false,
        type: 'route'
      },
    ...
    return [
      {
        id: 1,
        sender: '운행 관리팀',
        preview: '금일 오후 노선 101번 운행 관련 공지사항입니다.',
        date: '오늘 14:30',
        unread: true,
        priority: 'high'
      },
